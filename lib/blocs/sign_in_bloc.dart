...
class SignInBloc extends ChangeNotifier {
  ...
  Future saveDataToSP() async {
    ...
    await sp.setString('name', _name ?? "<empty name>");
    await sp.setString('email', _email ?? "<empty email>");
    await sp.setString('image_url', _imageUrl ?? "<no image>");
    await sp.setString('uid', _uid ?? "<no uuid>");
    await sp.setString('joining_date', _joiningDate ?? "<no join date>");
    await sp.setString('sign_in_provider', _signInProvider ?? "<no sign-in provider>");
  }
